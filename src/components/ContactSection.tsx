...
export const ContactSection = () => {
  return (
    <section id="contact" className="relative py-24 bg-obsidian border-t border-white/5 overflow-hidden">
      {/* Decorative details */}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col gap-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <Card hoverEffect={true} className="border-white/5 bg-charcoal-dark/40">
              <div className="flex items-start gap-4">
                <PhoneCall className="w-5 h-5 text-gold shrink-0 mt-1" />
                <div className="flex flex-col gap-1">
                  ...
                  >
                    <Button variant="accent" className="px-5 py-2.5 text-[10px]">
                      Message on WhatsApp
                    </Button>
                  </a>
                </div>
            ...
            <Card hoverEffect={true} className="border-white/5 bg-charcoal-dark/40">
              <div className="flex items-start gap-4">
                <Compass className="w-5 h-5 text-gold shrink-0 mt-1" />
                <div className="flex flex-col gap-1">
